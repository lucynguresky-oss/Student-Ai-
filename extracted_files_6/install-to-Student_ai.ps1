...
# Writes all backend files into the target folder below.
# Run from anywhere:  powershell -ExecutionPolicy Bypass -File install-learnix-backend.ps1

$ErrorActionPreference = 'Stop'
$enc  = New-Object System.Text.UTF8Encoding($false)
$base = 'C:\Users\jesse\Desktop\Student_ai'
...
Write-File 'AI_TUTOR_INTEGRATION.md' @'
...
Write-File 'apps/api/src/ai-tutor/ai-tutor.controller.ts' @'
import {
  Body,
  Controller,
  Delete,
...
Write-File 'apps/api/src/ai-tutor/ai-tutor.module.ts' @'
...
Write-File 'apps/api/src/ai-tutor/ai-tutor.service.ts' @'
import {
  ForbiddenException,
  Injectable,
  NotFoundException,
...
Write-File 'apps/api/src/ai-tutor/llm.service.ts' @'
...
Write-File 'apps/api/src/ai-tutor/prompts.ts' @'
/**
...
Write-File 'apps/api/src/common/text.util.ts' @'
...
Write-File 'apps/api/src/safety/safety.controller.ts' @'
import {
  Body,
  Controller,
  Delete,
...
Write-File 'apps/api/src/safety/safety.module.ts' @'
import { Module } from '@nestjs/common';
...
Write-File 'apps/api/src/safety/safety.service.ts' @'
import {
  BadRequestException,
  ForbiddenException,
  Injectable,
...
Write-File 'apps/api/src/saved/saved.controller.ts' @'
import {
  Body,
  Controller,
  Delete,
...
Write-File 'apps/api/src/saved/saved.module.ts' @'
import { Module } from '@nestjs/common';
...
Write-File 'apps/api/src/saved/saved.service.ts' @'
import {
  ForbiddenException,
  Injectable,
  NotFoundException,
...
Write-File 'apps/api/src/search/search.controller.ts' @'
...
Write-File 'apps/api/src/search/search.module.ts' @'
import { Module } from '@nestjs/common';
import { SafetyModule } from '../safety/safety.module';
...
Write-File 'apps/api/src/search/search.service.ts' @'
import { Injectable } from '@nestjs/common';
...
Write-File 'apps/api/src/stories/stories.controller.ts' @'
import {
  Body,
  Controller,
  Delete,
...
Write-File 'apps/api/src/stories/stories.module.ts' @'
import { Module } from '@nestjs/common';
import { SafetyModule } from '../safety/safety.module';
...
Write-File 'apps/api/src/stories/stories.service.ts' @'
import {
  ForbiddenException,
  Injectable,
  NotFoundException,
...
Write-File 'apps/api/src/users/dto/update-profile.dto.ts' @'
import {
  IsBoolean,
  IsNotEmpty,
  IsOptional,
...
Write-File 'apps/api/test/llm.spec.ts' @'
...
Write-File 'apps/api/test/text.spec.ts' @'
import assert from 'node:assert';
...
Write-Host ""
Write-Host "Done - 69 files written into $base"
